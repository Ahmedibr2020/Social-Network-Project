...
<body>
    <div class="container">
        ...
        if($flag == 0) { // Your Own Profile
            ...
            $profilesql = "SELECT users.user_id,users.user_nickname, users.user_gender, users.user_hometown, users.user_status, users.user_birthdate,
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // A form is posted
    if (isset($_POST['request'])) { // Send a Friend Request
        ...
        header("refresh:1; url=profile.php?id=".$current_id );
    }
////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
     else if(isset($_POST['phone'])) { // Add a Phone Number to Your Profile
       $sqlp="SELECT user_phone from user_phone WHERE user_phone.user_phone ={$_POST['number']} ";
        ...
        echo 'phone is already added before'; }
    }
    sleep(4);
}
?>
