    ...
    <div class="container">
        ...
        <div class="createpost">
            <form method="post" action="" onsubmit="return validatePost()" enctype="multipart/form-data">
                ...
                <label style="float:right;font-weight:bold; color:white;" for="public">Public</label>
                </span>
                <label style="color:white; font-weight:bold;">Caption </label>
                <span class="required" style="display:none;"> *You can't Leave the Caption Empty.</span><br>
                <textarea  rows="6" name="caption"></textarea>

                <center><img src="" id="preview" style="max-width:900px; display:none;"></center>
                <div class="createpostbuttons">
                    ...
                    <input type="submit" style="float:right;"value="Post" name="post">
                    <!--</form>-->
                </div>
            </form>
        </div>
